export const AUTHORING_VOCABULARY_V1 = [
  ...
  '- Use ```chart with strict JSON for statistical charts: v:1, type, inline data, and x/y/value/series columns. Types: line, scatter, grouped-bar, histogram, density, violin, confidence-band, heatmap, contour. Reject URLs, HTML, callbacks, and library config. Example: {"v":1,"type":"line","data":[{"x":"Jan","y":3}],"x":"x","y":"y"}.',
  '- Use ```trace with strict JSON (v:1, actors, ordered events) to replay send, enqueue, start, complete, retry, timeout, and failure events. Example event: {"at":0,"type":"send","from":"api","to":"jobs","item":"request-1"}.',
  '- Use ```sim with strict JSON (v:1, seed, duration, queues, pools, arrivals) for bounded queueing simulations. Pools specify capacity, queue, service time, and optional failure/retry. Example service: {"distribution":"constant","value":2}.',
